 ...
 * parameters:  void
 * description: The function initializes the DMA module of TC375, which hosts all DMA channels.
 */
...
HAL_Return_Type Func_DMA_Ch0_init (void)
{
     ...
     * field 19: RROAT: 0x1: a new DMA request is required after each DMA transaction
     * field 20: CHMOD: 0x1: continuous mode
     * field 23..21: CHDW: 0x1: 16 bit wide moves
     * field 26..24: PATSEL: 0x0: no pattern detection
     * field 27: SWAP: 0x0: no swap
     * field 28: PRSEL: 0x0: DMA HW request
     * field 31..29: reserved
     */
    ...
    /*
     * Initialization of the DMA channel 0, Channel Address and Interrupt Control Register ADICR
     *
     * field 2..0: SMF: 0x0, source address offset update is 1 x 16 bit for each move
     * field 3: INCS: 0x1, source addresses will be increased
     * field 6..4: DMF: 0x0, destination address offset update is 1 x 16 bit for each move
     * field 7: INCD: 0x1, destination address will be increased; this is for documentation purpose only; the destination address will not change.
     * field 11..8: CBLS: 0x3, circular buffer source length is 4 entries a 16 bits
     * field 15..12: CBLD: 0x0, destination circular buffer address is unchanged; destination address stays the same.
     * field 19..16: SHCT: 0x0, move operation
     * field 20: SCBE: 0x1, use source circular buffer
     * field 21: DCBE: 0x1, destination circular buffer; but the destination address stays the same.
     * field 22: STAMP: 0x0, no time stamp
     * field 23: reserved
     * field 24: WRPSE: 0x0, no wrap source interrupt
     * field 25: WRPDE: 0x0, no wrap destination interrupt
     * field 27..26: INTCT: 0x0, no interrupt on changing TCOUNT
     * field 31..28: IRDV: 0x0, no interrupt raise detect
     *
     */
    ...
    /*
     * DMA_CH0_SADR,        // initialization of the DMA Channel 0 Source Address register
     * DMA_CH0_DADR,        // initialization of the DMA Channel 0 Destination Address register
     */
    ...
    /*
     * DMA_EER0,           // initialization of the error report enable register of ME 0; no error reports.
     * DMA_EER1,           // initialization of the error report enable register of ME 1; no error reports.
     */
