...
/*-----------------------------------------------------Defines-------------------------------------------------------*/
/*********************************************************************************************************************/
#define CAN0_MSGRAM_BASE      ((uint32)CAN0_RAM)
#define MSGRAM_WORD_OFFSET(addr)   ((((uint32)(addr)) - CAN0_MSGRAM_BASE) >> 2)
 ...
 */
CAN_Module0_MsgRAM_struct *ptr_MCAN0_MsgRAM = (CAN_Module0_MsgRAM_struct *)CAN0_RAM;
...
HAL_Return_Type Func_MsgRAM_init (void)
{
    ...
    CAN0_TXBC0.B.TBSA = MSGRAM_WORD_OFFSET(&ptr_MCAN0_MsgRAM->Region_CAN0_Tx_Buffers[0]);
...
HAL_Return_Type Func_CAN0_Tx_buffer0_init (uint8 msg_nr)
{
    ...
    ptr_MCAN0_MsgRAM->Region_CAN0_Tx_Buffers[0].Tx_Buffer_T1.DLC = 2;           // 2 data bytes per frame since we are sending conv_result_stable which is 2 bytes
