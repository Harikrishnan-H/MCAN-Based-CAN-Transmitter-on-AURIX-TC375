...
void task_Display (void *arg)
{
    ...
    while (TRUE)
    {
           ...
           u16_to_4_digits(conv_result_stable, digits);
...
/*********************************************************************************************************************/
/*
 * The function digit_to_prompt converts a decimal digit (0..9) into the corresponding DisplayPrompt
 * constant used by the 4-segment display driver.
 *
 * If the input digit is out of range, the display is switched OFF for that position.
 *
 */
...
/*********************************************************************************************************************/
/*
 * The function u16_to_4_digits splits a 16-bit unsigned value into 4 decimal digits (ones...thousands).
 * It writes the digits into an array:
 *  - digits[0] = ones
 *  - digits[1] = tens
 *  - digits[2] = hundreds
 *  - digits[3] = thousands
