...
extern L02_Return_Type Func_return_G3C0_conv_result(volatile uint16 *result);

/*********************************************************************************************************************/
/*-------------------------------------------------Global variables--------------------------------------------------*/
/*********************************************************************************************************************/

volatile uint16 conv_result; //variable stores the ADC result
volatile uint16 conv_result_stable; //variable stores the masked stable ADC result
...
void task_EVADC_Conversion(void *arg)
{
    ...
    while (TRUE)
    {
        ...
        if (valid == TRUE)
        {
            ...
            /* Cut off last 4 bits to stabilize the result */
           conv_result_stable = conv_result & 0xFFF0;
